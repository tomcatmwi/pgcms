 ...
 * WARNING: tigers may rip out your heart
*/
...
lwRTE.prototype.enable_design_mode = function() {
	...
	var doc = "<html><head>" + base + css + "</head><body " + style + " class='article' style='padding: 5px'>" + content + "</body></html>";
...
lwRTE.prototype.get_selection_range = function() {
	...
	if(iframe_window.getSelection) {
		...
		if(typeof $.browser !== 'undefined' && $.browser.opera) { //v9.63 tested only
